...
instance.interceptors.request.use(
    (config) => {
        ...
        config.headers['Authorization'] = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJOYW1lIjoiYWRtaW4iLCJPcGVuaWQiOiIiLCJVc2VyaWQiOjAsIkF2YXRhclVSTCI6IiIsIkxvZ2luSWQiOiJ6aHVqaWUiLCJMb2dpblB3ZCI6InpodWppZSIsIkxldmVsIjowLCJleHAiOjE2NjM1NzAzNzcsImlzcyI6InpodWppZSJ9.3MXQ2I-tQFG69WKgWNkVdtAYGC9CaVZtpJls-Nh6CAY"
        return config;
