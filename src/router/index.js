...
export const asyncRoutes = [{
...

    {
        ...
        children: [{
                ...
                name: 'ElementComp',
                component: () =>
                    import ('@/views/element/index.vue'),
                meta: {
                ...
                path: '/goodManager',
                component: () =>
                    import ('@/views/goodManager/index.vue'),
                meta: {
                    title: '商品管理',
                }
            },
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        name: 'OtherChart',
                        component: () =>
                            import ('@/views/echarts/other.vue'),
                        meta: {
